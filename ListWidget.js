...
define([
  ...
  "dojo/_base/lang",
    "dijit/_WidgetBase",
  //Dijit's template system allows you to create more complext widgets from templates through the use of _widgetInTemplateMixix mixin. This mixin tells the template system that your template has widgets in it and to instatiate them when your widget is instantiated
  ...
  return declare("ListWidget", [_WidgetBase, _TemplatedMixin, WidgetProxy], {
    ...
    hostReady: function () {
      ...
      // where does "dgrid-select" come from??.....--list name?
    ...
    dataSourceExpired: function (dataSourceProxy, dataSourceConfig) {
      ...
      dataSourceProxy.executeQuery(this.query).then(function (featureSet) {
        if (featureSet.features) {
         ...
         // datasourceProxy.objectIdFieldName, read the name of the object id field
